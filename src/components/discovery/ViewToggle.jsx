...
function ViewToggle({ className }) {
  ...
  return (
    <div className={`inline-flex shrink-0 rounded-full border border-[var(--color-border-subtle)] bg-[rgba(255,255,255,0.04)] p-0.5 xs:p-1 ${className}`}>
      {[
        ...
        <button
          ...
          className={`rounded-full px-3 py-2.5 transition xs:px-4 xs:py-3 ${viewMode === mode ? 'bg-[var(--color-brand-primary)] text-white' : 'text-[var(--color-text-secondary)]'}`}
        >
